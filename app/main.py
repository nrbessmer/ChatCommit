...
from .routers import branch, commit, rollback, tag, timeline, auth, user, subscription, stripe  # adjust if any are unused
...
def initialize_default_branch():
    ...
    if db.query(Branch).count() == 0:
        # create an initial “init” commit and “main” branch
