...
export default function BranchesPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 text-white">
      ...
      {branches.map(branch => (
        <div key={branch.id} className="bg-gray-800 rounded-lg p-4 mb-4 shadow-lg">
          ...
          <Link href={`/branches/${branch.id}`} className="text-blue-400 hover:underline mt-2 inline-block">
            View Commits →
          </Link>
        </div>
      ))}
